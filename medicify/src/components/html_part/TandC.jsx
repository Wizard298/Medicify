  ...
  return (
    <>
      <div className="termsAndPolicy">
        ...
        relationship with the Medicify online pharmacy application (the
        ...
        right to provide the information to third parties for purposes of
        facilitating the completion of Purchases. We reserve the right to refuse
        or cancel your order at any time for certain reasons including but not
        limited to: product or service availability, errors in the description
        or price of the product or service, error in your order, or other
        reasons.
        <br />
        <br />
        <h3>Accounts</h3>
        ...
        laws of both the [Country Name] and foreign countries. Our trademarks
        and trade dress may not be used in connection with any product or
        service without the prior written consent of [Your Company Name].
        <br /> <br />
        <h3>Links To Other Web Sites</h3>
        Our Service may contain links to third-party web sites or services that
        are not owned or controlled by [Your Company Name]. [Your Company Name]
        ...
        You further acknowledge and agree that [Your Company Name] shall not be
        ...
        agree to the new terms, please stop using the Service. Contact Us If you
