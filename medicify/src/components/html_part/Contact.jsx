...
function Contact() {
  return (
    ...
    <div className="contact">
        <h1>Contact Us</h1>
        <p>At Medicify App, we value your feedback and are here to assist you with any questions or concerns. There are several ways to get in touch with us:</p>
        ...
        <ol>
            <li>Email: support@medicifyapp.com</li>
        ...
        <ol>
            <li>Email: business@medicifyapp.com</li>
        </ol>

        <h2>Contact with Us</h2>
        <p>Stay updated with the latest news, promotions, and product releases by following us on social media:</p>
        <ol>
            <li>Facebook: facebook.com/medicifyapp</li>
            <li>Instagram: instagram.com/medicifyapp</li>
            <li>Twitter: twitter.com/medicifyapp</li>
        </ol>
